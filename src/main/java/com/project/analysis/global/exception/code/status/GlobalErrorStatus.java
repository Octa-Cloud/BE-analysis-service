package com.project.analysis.global.exception.code.status;

import com.project.analysis.global.exception.code.BaseCode;
import com.project.analysis.global.exception.code.BaseCodeInterface;
...
public enum GlobalErrorStatus implements BaseCodeInterface {
    ...
    ALREADY_SLEPT(HttpStatus.BAD_REQUEST, "ANALYSIS400", "이미 분석을 진행하였습니다.")
